        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16 lg:h-20">
                ...
                <div className="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
                    <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80"> Docs </a>
                </div>

                <div className="lg:flex lg:items-center lg:justify-end lg:space-x-6 sm:ml-auto">
                    <a href="#" title="" className="hidden text-base text-white transition-all duration-200 lg:inline-flex hover:text-opacity-80"> Recover </a>

                    <a href="#" title="" className="inline-flex items-center justify-center px-3 sm:px-5 py-2.5 text-sm sm:text-base font-semibold transition-all duration-200 text-white bg-white/20 hover:bg-white/40 focus:bg-white/40 rounded-lg" role="button"> Get Started </a>
                </div>
    ...
    <section className="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            ...
            <h3 className="text-4xl font-bold sm:text-6xl">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Zchat</span>
                </h3>
                ...
                <h1 className="text-4xl font-bold sm:text-6xl">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Simplified Secure Messaging</span>
                </h1>
                <p className="mt-5 text-base text-white sm:text-xl">Minimalistic Secure and Reliable Communication</p>
                ...
                <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Secure P2P messaging </p>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Privacy via IP masking </p>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Robust Authentication and Authoritization</p>
                    </div>
                </div>
            </div>
        </div>
